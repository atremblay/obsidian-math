...
To model a very quick impulse to a system we make use of the [[Dirac Delta Function]] and the [[Mean value theorem#Integral | mean value theorem for the integral]]
