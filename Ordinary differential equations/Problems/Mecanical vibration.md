...
By [[../../Calculus/Hooke's law]], the restoring force on the mass by the spring is proportional to the displacement $x$.
$$F_s = -kx$$
...
$$F=mx'' = F_s + F_f = -kx -cx'$$
This is a direct application of [[../Solutions/Const Coeff Homo DE|constant coefficient homogeneous differential equation]]. 
$$mx''+cx'+kx=0$$
As often, guess: $x=e^{rt}$

The [[../../Calculus/Characteristic equation]] is $mr^2+cr+k=0$ and the roots are
$$
r = \frac{-c \pm \sqrt{c^2-4mk}}{2m}
$$
There will be 3 cases for the possible values of the roots

### [[../Solutions/Const Coeff Homo DE#Case 1 Distinct roots|Case 1]] Distinct roots
...
The [[../../Calculus/General solution]] $x=c_1e^{r_1t} + c_2e^{r_2t}$ decays to the neutral position ($x=0$) overtime. There will not be any back and forth. This is called **overdamped**.


### [[../Solutions/Const Coeff Homo DE#Case 2 Repeated root|Case 2]] Repeated root
If $c^2-4mk=0$ then we have one real repeated root $r=\frac{-c}{2m}$.

The [[../Solutions/Const Coeff Homo DE#General solution|general solution]] is
$$x=c_1e^{rt} + c_2te^{rt}$$


### [[../Solutions/Const Coeff Homo DE#Case 3 Complex pair of roots|Case 3]] Complex pair of root
...
Using [[../../Trigonometry/Trigonometric identity#Sum and difference of angles|trigonometric identity of cosine]] $\cos(\delta-\gamma)=\cos\delta\cos\gamma+\sin\delta\sin\gamma$, can we rearrange $c_1\textcolor{orange}{\cos \omega t} + c_2\textcolor{cyan}{\sin \omega t}$ To have the left-hand side instead? This is not required, it just shows a cleaner solution.
...
\end{align}
$$
To give it a more familiar look ([[../Solutions/Const Coeff Homo DE]])
